...
FileListModel::FileListModel(QList<FileInfo> list, QObject *parent)
...
bool FileListModel::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
